@VFG10X-2176 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2176 Promotions and Discounts _ Item level Discount_In a Sale transaction with 2 items, Apply 15$ OFF
