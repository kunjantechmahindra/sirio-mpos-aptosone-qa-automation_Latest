@VFG10X-1598 @ExchangeTransaction @Regression
Feature: VFG10X-1598 DCK-Exchange with Employee discount applied at Transaction level with Split Tenders Cash and Card

  Scenario: DCK-Exchange with Employee discount applied at Transaction level with Split Tenders Cash and Card
  ...
  #Login and add product
    ...
    #Partial transaction with card and cash
    And the sales assistant clicks on Pay button
    And the sales assistant save the transaction details of the sales transaction
