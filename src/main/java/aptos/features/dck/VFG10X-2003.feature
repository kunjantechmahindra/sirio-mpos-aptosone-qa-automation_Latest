@VFG10X-2003 @Regression @ExchangeTransaction @Card @Visa
Feature: VFG10X-2003 Exchange _Blind Exchange _Single item with Tax override by amount  _Refund as card_No Customer

  Scenario: Exchange _Blind Exchange _Single item with Tax override by amount  _Refund as card_No Customer
