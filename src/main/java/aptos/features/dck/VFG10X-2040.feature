@VFG10X-2040 @ReturnTransaction @Regression @DetailedCalculation

Feature: VFG10X-2040 Promotions and Discounts _ Sale transaction with Temporary markdown and Promotion(with coupon) on same line item and apply manual transactional discount
