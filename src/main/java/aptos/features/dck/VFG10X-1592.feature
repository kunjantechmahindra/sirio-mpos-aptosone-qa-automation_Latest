...
Feature: VFG10X-1592 DCK - Exchange _Transaction level percentage off discount_Sale transaction should have transaction level percent off discount
  ...
  Scenario:  DCK - Exchange _Transaction level percentage off discount_Sale transaction should have transaction level percent off discount
  ...
  #Transactional level percentage 30% off
    ...
    And the sales assistant enter discount percentage as 1
    ...
    And the sales assistant validate transactional level percentage off 1 applied for 1 items
