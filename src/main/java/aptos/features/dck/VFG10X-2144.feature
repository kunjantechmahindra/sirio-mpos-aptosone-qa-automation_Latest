@VFG10X-2144 @TaxManagement @Regression
Feature: VFG10X-2144 Tax _ Exchange transaction with multiple items with Tax Override, and Tax Exempt, Get E-Receipt

  Scenario: Tax _ Exchange transaction with multiple items with Tax Override, and Tax Exempt, Get E-Receipt
