@VFG10X-2022 @SaleTransaction @Regression @DetailedCalculation
Feature: VFG10X-2022 Sale Transaction _Multiple Items with Temporary Price + Price Override + Employee Discount and BOGO Promotion_ Payment by cash
  ...
  Scenario: Sale Transaction _Multiple Items with Temporary Price + Price Override + Employee Discount and BOGO Promotion_ Payment by cash
   ...
   #Add Temp MD item
    Then the sales assistant add 1 items from "WithOutCoupon-10%-CanBeCombined" product to the basket
