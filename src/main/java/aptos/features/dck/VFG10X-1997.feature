@VFG10X-1997 @Regression @DetailedCalculation @Card @VisaDebit
Feature: VFG10X-1997 Return transaction _Return single Temp MD item payment by Visa Debit insert
