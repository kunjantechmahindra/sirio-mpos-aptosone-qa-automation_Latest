@VFG10X-2179 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2179 Promotions and Discounts _ Item level Discount _in a sales transaction where 1st item 50% OFF,2nd Item 30$ OFF
