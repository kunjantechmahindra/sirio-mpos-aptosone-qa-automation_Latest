@VFG10X-2157 @ExchangeTransaction @Regression
Feature: VFG10X-2157 DCK - Exchange transaction of quantity updated items with sale of quantity updated

  Scenario: DCK - Exchange transaction of quantity updated items with sale of quantity updated
