@VFG10X-2145 @TaxManagement @Regression
Feature: VFG10X-2145 Tax _ Exchange transaction of Multiple item, 1st Item with tax exempt and voided, 2nd item with standard tax
