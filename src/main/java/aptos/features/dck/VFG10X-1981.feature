@VFG10X-1981 @PromotionsAndDiscounts @Regression @DetailedCalculation
Feature: VFG10X-1981 Promotions and Discounts _ Sale transaction with Coupon - 20% with Coupon
