@VFG10X-2029 @StoreSelling @Regression
Feature: VFG10X-2029 Return Transaction_ Blind Return with Single item with Price override and employee discount applied during return_Refund as Cash

  Scenario: Return Transaction_ Blind Return with Single item with Price override and employee discount applied during return_Refund as Cash
