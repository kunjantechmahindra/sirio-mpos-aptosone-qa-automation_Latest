@VFG10X-2172 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2172 Promotions and Discounts _Transactional level discount reason code_Group

  Scenario: Promotions and Discounts _Transactional level discount reason code_Group
