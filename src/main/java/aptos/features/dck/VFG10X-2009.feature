@VFG10X-2009 @PromotionsAndDiscounts @Regression @GiftCard

Feature: VFG10X-2009 Promotions and Discounts _ Verify that promotion is not getting applied to Top Up Gift Card

  Scenario: Promotions and Discounts _ Verify that promotion is not getting applied to Top Up Gift Card
  ...
  #Issue New Gift Card
    ...
    And the sales assistant enters gift card amount "10.00"
