@VFG10X-2102 @Regression @StoreSelling
Feature: VFG10X-2102 Store Selling Functions _Validation of Items line display on both Virtual and Physical  Receipts _when more than one of same item is added
