@VFG10X-2070 @StoreSelling @Regression
Feature: VFG10X-2070 DCK_ Store Selling Functions_ Sale and Return in same transaction

  Scenario: DCK_ Store Selling Functions_ Sale and Return in same transaction
