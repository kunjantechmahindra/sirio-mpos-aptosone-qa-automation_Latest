@VFG10X-2165 @SaleTransaction @Regression
Feature: VFG10X-2165 Sale Transaction _Perform a sale transaction by multiplying the quantity of Upc, apply tax exempt to the transaction

  Scenario: Sale Transaction _Perform a sale transaction by multiplying the quantity of Upc, apply tax exempt to the transaction
  ...
  #Login and add product
    ...
    And the sales assistant add 3 quantity to the order
