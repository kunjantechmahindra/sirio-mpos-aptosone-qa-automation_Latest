@VFG10X-2123 @StoreSelling @Regression

Feature: VFG10X-2123 Store Selling Functions _ Promotions should not  be applied to eligible items during Blind Return
  ...
  Scenario: Store Selling Functions _ Promotions should not  be applied to eligible items during Blind Return
    ...
    #Add Product
    Then the sales assistant add an items from "WithOutCoupon-10%-CanBeCombined" product for return
