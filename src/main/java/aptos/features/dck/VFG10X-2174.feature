@VFG10X-2174 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2174 Promotions and Discounts _Transactional level discount reason code_CLEARANCE

  Scenario: Promotions and Discounts _Transactional level discount reason code_CLEARANCE
