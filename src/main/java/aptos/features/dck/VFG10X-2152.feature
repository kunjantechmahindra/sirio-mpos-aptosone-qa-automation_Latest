@VFG10X-2152 @TaxManagement @Regression

Feature: VFG10X-2152 Tax _ Return Transaction with three items_ Tax Exempt applied to all items
  ...
  #Add Temp MD product with permanent price
