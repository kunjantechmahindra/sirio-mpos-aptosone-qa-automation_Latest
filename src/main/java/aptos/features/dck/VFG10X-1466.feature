@VFG10X-1466 @Regression @GiftCard
Feature: VFG10X-1466 DCK - Gift Card - Top up gift Card (Legacy gift card)

  Scenario: DCK - Gift Card - Top up gift Card (Legacy gift card)
