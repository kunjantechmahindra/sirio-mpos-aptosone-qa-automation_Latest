@VFG10X-1998 @PromotionsAndDiscounts @Regression @DetailedCalculation
Feature: VFG10X-1998 Promotions and Discounts _ Return transaction with multiple promotions and Employee discount 60% off applied
