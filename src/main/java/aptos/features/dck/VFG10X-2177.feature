@VFG10X-2177 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2177 Promotions and Discounts _ Item level Discount _in a sales transaction where 1st item 10% OFF,2nd Item 15$ OFF
