@VFG10X-1528 @ExchangeTransaction @Regression
Feature: VFG10X-1528 Exchange with discount applied at item level % off - Sale item

  Scenario: Exchange with discount applied at item level % off - Sale item
