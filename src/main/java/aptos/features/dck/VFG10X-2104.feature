@VFG10X-2104 @StoreSelling @Regression
Feature: VFG10X-2104 Store Selling Functions _Validation of if store-copy receipt slip be printed when a Return is performed
