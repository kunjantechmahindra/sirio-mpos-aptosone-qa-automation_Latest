@VFG10X-2171 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2171 Promotions and Discounts _Transactional level discount reason code_SENIOR CITIZEN

  Scenario: Promotions and Discounts _Transactional level discount reason code_SENIOR CITIZEN
