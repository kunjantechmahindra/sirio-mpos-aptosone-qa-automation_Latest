@VFG10X-2087 @Regression @StoreSelling
Feature: VFG10X-2087 Store Selling Functions_ Transactional Level Sales person Assignment
  ...
  Scenario: Store Selling Functions_ Transactional Level Sales person Assignment
    ...
    And the sales assistant add salesperson "800100" to the transaction
