@VFG10X-2162 @SaleTransaction @Regression
Feature: VFG10X-2162 Sale Transaction _Perform a sale transaction by multiplying the quantity of Upc, apply tax override to the UPC.

  Scenario: Sale Transaction _Perform a sale transaction by multiplying the quantity of Upc, apply tax override to the UPC.
  ...
  #Login and add product
    ...
    And the sales assistant enter new tax as 1
    And the sales assistant lands on Basket Page
