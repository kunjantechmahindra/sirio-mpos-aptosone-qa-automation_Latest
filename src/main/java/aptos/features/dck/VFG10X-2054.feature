@VFG10X-2054 @StoreSelling @Regression @GiftCard
Feature: VFG10X-2054 Store Selling Functions _ Maximum Gift Card Top UP Amount
  ...
  #Issue New Gift Card
    ...
    And the sales assistant enters gift card amount "200.01"
    And the sales assistant validate the displayed error message
    And the sales assistant validate add value is disabled
    And the sales assistant enters valid gift card amount "200.00"
