@VFG10X-1639 @SFCC @PrerequisiteRequired

Feature: VFG10X-1639 SFCC_ Update a Dickies promotion with coupon
  Scenario: SFCC_ Update a Dickies promotion with coupon
    ...
    And the sales assistant enter the promotion ID "12082024"
    ...
    And sales assistant enter the promotion ID "12082024" for promotions
