@VFG10X-1479 @CashManagement @Regression @SmokeDCK

Feature: VFG10X-1479 DCK - Cash Management_Safe to Till_Dickies

  Scenario: DCK - Cash Management_Safe to Till_Dickies
