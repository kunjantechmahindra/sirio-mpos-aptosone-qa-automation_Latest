@VFG10X-2178 @PromotionsAndDiscounts @Regression
Feature: VFG10X-2178 Promotions and Discounts _ Item level Discount _in a sales transaction where 1st item 30% OFF,2nd Item 50$ OFF
