@VFG10X-2308 @StoreSelling @Regression @GiftCard
Feature: VFG10X-2308 Store Selling Functions _ Maximum Gift Card Issue Amount
  ...
  #Issue New Gift Card
    ...
    And the sales assistant enters valid gift card amount "500.00"
