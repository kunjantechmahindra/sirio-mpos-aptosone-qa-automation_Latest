@VFG10X-1882 @Customer @Regression
Feature: VFG10X-1882 Create a  Customer with Mandatory fields +  Opt-in to Newsletter first

  Scenario: Customer _Create a  Customer with Mandatory fields +  Opt-in to Newsletter first
