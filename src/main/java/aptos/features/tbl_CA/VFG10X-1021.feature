@VFG10X-1021 @PromotionsAndDiscounts @Regression
Feature: VFG10X-1021 Promotions and Discounts _Transaction level Discount_In a Sale transaction with 2 items, Apply 30$ OFF
  ...
  #Transactional level amount Discount 30$ off
    ...
    And sales assistant validates transactional level discount 30 applied
