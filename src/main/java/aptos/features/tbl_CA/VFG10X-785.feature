@VFG10X-785 @CashManagement @Regression
Feature: VFG10X-785 Cash Management _PAID IN_ Reason Code - Drawer/Safe Fund

  Scenario: Cash Management _PAID IN_ Reason Code - Drawer/Safe Fund
