@VFG10X-2296 @Regression @GiftCard

Feature: VFG10X-2296 Gift Card _Unable to apply Item Level & Transactional Level discount and Price Override a New Gift card Item in a transaction
