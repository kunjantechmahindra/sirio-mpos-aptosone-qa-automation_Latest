@VFG10X-2298 @Regression @GiftCard @Card @Smoke @SmokeTesting
Feature: VFG10X-2298 Gift Card _ Balance Enquiry by swiping the gift card + PIN entry
  ...
  # Gift card balance enquiry
    Then the sales assistant validates the Gift Card balance from basket page for index 8 by swipe
