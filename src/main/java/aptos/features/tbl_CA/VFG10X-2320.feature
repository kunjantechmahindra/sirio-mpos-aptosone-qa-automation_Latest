@VFG10X-2320 @DetailedCalculation @Regression
Feature: VFG10X-2320 Return Transaction _Blind Return of multiple items _ item level discount to one item and add tax override to one item_ Refund to Master card_ No customer assigned
