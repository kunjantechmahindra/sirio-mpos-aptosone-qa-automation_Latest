@VFG10X-1752 @ReturnTransaction @Regression @DetailedCalculation

Feature: VFG10X-1752 Return Transaction _Multiple items with Tax exempt and one without tax exempt_ coupon applied _Existing customer Assigned
