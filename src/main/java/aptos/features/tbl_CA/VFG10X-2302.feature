@VFG10X-2302 @PromotionsAndDiscounts @Regression @GiftCard
Feature: VFG10X-2302 Promotions and Discounts _ Verify that promotion is not getting applied to Top Up Gift Card
