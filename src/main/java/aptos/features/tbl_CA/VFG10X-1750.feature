@VFG10X-1750 @ReturnTransaction @Regression @DetailedCalculation

Feature: VFG10X-1750 Return Transaction _ Receipt Return with %off item having Price Override and Promo applied
  ...
  #Login
   ...
   # Price override
    ...
    And the sales assistant lands on Basket Page
    And the sales assistant validate the price of the product is 30 at index 1
