@VFG10X-825 @CashManagement @Regression
Feature: VFG10X-825 Cash Management _PAID OUT_ Reason Code - Drawer/Safe Fund

  Scenario: Cash Management _PAID OUT_ Reason Code - Drawer/Safe Fund
  ...
  #PAID OUT Store Operations
    ...
    And the sales assistant selects "DRAWER/SAFE FUND" as reason code
