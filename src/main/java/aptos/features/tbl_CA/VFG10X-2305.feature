@VFG10X-2305 @GiftCard @Regression @StoreSelling
Feature: VFG10X-2305 Sale Transaction _Single Item with Line item Discount _Payment by multiple Gift Cards
  ...
  #EJ Validation
    ...
    And the sales assistant validate if reason code "DAMAGED/DEFECT" is displayed
