@VFG10X-2322 @ExchangeTransaction @GiftCard @Card @DetailedCalculation
Feature: VFG10X-2322 Exchange _Negative Blind Exchange of single item with bag fee on exchange transaction_Issue New Gift card for refund_No Customer Assigned
