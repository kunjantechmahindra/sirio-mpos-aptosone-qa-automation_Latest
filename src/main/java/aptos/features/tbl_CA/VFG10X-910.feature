@VFG10X-910 @CashManagement @Regression
Feature: VFG10X-910 Cash Management _PAID IN _ TBL Reason Code validation_Alphabetic order

  Scenario: Cash Management _PAID IN _ TBL Reason Code validation_Alphabetic order
