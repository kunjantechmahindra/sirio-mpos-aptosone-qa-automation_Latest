...
Feature: VFG10X-809 Cash Management _PAID IN_ Reason code - Customer Accommodations for TBL.

  Scenario: Cash Management _PAID IN_ Reason code - Customer Accommodations for TBL.
  ...
  #PAID IN Store Operations
    ...
    And the sales assistant selects "CUSTOMER ACCOMODATIONS" as reason code
