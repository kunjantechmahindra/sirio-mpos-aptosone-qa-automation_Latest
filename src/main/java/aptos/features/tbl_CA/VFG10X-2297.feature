@VFG10X-2297 @Regression @GiftCard
Feature: VFG10X-2297 Gift Card _Unable to apply Item Level , Transactional Level discount and Price Override a Top Up Gift card Item in a transaction
