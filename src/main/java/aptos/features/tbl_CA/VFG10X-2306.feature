@VFG10X-2306 @StoreSelling @Regression @GiftCard @Smoke @SmokeTesting
Feature: VFG10X-2306 Store Selling Functions _Only Gift card to cash option is there for Tender exchange
