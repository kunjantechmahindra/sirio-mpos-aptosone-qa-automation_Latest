@VFG10X-1579 @TaxManagement @ReturnTransaction @Regression
Feature: VFG10X-1579 Perform Return transaction with multiple items with Tax Override,and Tax Exempt, Get E-Receipt

  Scenario: Perform Return transaction with multiple items with Tax Override,and Tax Exempt, Get E-Receipt
