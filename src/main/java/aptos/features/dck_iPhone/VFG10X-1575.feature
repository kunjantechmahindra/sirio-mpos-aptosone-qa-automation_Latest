@VFG10X-1575 @ReturnTransaction @Regression
Feature: VFG10X-1575 DCK - iPhone - Sales transaction with with Tax Exempt for three items

  Scenario: DCK - iPhone - Sales transaction with with Tax Exempt for three items
  ...
  #Apply Transactional level Tax exempt
