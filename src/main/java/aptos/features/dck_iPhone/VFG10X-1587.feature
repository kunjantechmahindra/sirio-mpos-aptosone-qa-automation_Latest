@VFG10X-1587 @CashManagement @Regression

  Feature: VFG10X-1587 DCK - iPhone - Cash Management_Safe to Till_Dickies

    Scenario: DCK - iPhone - Cash Management_Safe to Till_Dickies
