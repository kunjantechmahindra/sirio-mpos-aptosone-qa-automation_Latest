@VFG10X-2221 @ReturnTransaction @Regression
Feature: VFG10X-2221 Return Transaction _Sale of multiple items with multiple employees assigned and item and transactional discount Existing Customer Assigned
