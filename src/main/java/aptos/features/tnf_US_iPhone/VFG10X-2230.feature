@VFG10X-2230 @SaleTransaction @Regression @Card @GiftCard @Visa
Feature: VFG10X-2230 Sale Transaction _Normal item and Gift card item_ Partial Payment by Cash & Visa Card_ No customer
