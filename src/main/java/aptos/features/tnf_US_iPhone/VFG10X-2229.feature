@VFG10X-2229 @SaleTransaction @Regression @GiftCard @Card
Feature: VFG10X-2229 Sale Transaction _Multiple Items with multiple line item discounts _Payment by New Gift Card_ Existing customer
  ...
  #Assign customer
    ...
    And the sales assistant search product by style number "00AR9R"
