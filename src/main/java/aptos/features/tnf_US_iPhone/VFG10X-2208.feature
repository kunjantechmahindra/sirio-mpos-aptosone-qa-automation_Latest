@VFG10X-2208 @ExchangeTransaction @Regression @GiftCard @Card

Feature: VFG10X-2208 Exchange _Multiple sale items _Void one item and void payment by gift card and complete by cash
