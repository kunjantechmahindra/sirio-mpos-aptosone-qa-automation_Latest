@VFG10X-2193 @Customer @Regression
Feature: VFG10X-2193 Customer _Customer creation with incorrect phone number format

  Scenario: Customer _Customer creation with incorrect phone number format
