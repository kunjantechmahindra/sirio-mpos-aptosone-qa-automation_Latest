@VFG10X-2231 @SaleTransaction @Regression @GiftCard
Feature: VFG10X-2231 Sale Transaction _Single Item with Line item Discount _Payment by multiple Gift Cards
