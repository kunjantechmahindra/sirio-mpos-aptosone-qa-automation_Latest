@VFG10X-2223 @ReturnTransaction @Regression @Card @Discover
Feature: VFG10X-2223 Return Transaction _ Receipt Return with Different reason codes _DAMAGED/DEFECTIVE and WRONG SIZE/COLOR
