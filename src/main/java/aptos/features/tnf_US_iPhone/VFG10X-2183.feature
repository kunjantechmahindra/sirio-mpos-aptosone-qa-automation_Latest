@VFG10X-2183 @Regression @ExchangeTransaction @Card @Visa

Feature: VFG10X-2183 Exchange _Blind Exchange _Single item with Tax override _Refund as card_No Customer
