@VFG10X-2220 @ReturnTransaction @Regression @Card @Diners

Feature: VFG10X-2220 Return Transaction _Sale of Single item with Promo _Refund to Diners card _Existing Customer
