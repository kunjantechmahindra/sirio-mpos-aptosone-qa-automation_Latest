@VFG10X-2225 @ReturnTransaction @Regression
Feature: VFG10X-2225 Return Transaction _Return item with Physical receipt _Refund by Cash _New customer assigned
