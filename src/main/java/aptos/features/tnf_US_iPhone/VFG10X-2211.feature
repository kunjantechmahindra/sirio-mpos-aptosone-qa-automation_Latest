@VFG10X-2211 @ExchangeTransaction @Regression @GiftCard @Card

Feature: VFG10X-2211 Exchange _Multiple items with same price _Top Up gift card_ Loyalty Customer Assigned
