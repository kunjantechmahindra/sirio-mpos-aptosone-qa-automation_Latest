@VFG10X-2227 @SaleTransaction @Regression @Card @Master
Feature: VFG10X-2227 Sale Transaction _Single Item with Bag Fee_ Void Payment by Credit Card and complete by Cash_ Existing customer
