@VFG10X-2224 @ReturnTransaction @Regression @Card @Discover
Feature: VFG10X-2224 Return Transaction _ Receipt less Return with Different reason codes _CHANGED MIND and PRICE ADJUSTMENT
