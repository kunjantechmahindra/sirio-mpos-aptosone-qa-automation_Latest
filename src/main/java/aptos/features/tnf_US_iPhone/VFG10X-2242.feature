@VFG10X-2242 @Regression @StoreSelling
Feature: VFG10X-2242 Store Selling Functions_ Transactional Level Sales person Assignment
  ...
  Scenario: Store Selling Functions_ Transactional Level Sales person Assignment
    ...
    And the sales assistant add salesperson "800500" to the transaction
