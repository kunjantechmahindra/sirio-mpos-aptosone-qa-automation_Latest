@VFG10X-1811 @CashManagement @Regression
Feature: VFG10X-1811 Cash Management _ Validation of Till In Transactions - Starting Bank Initialize the Drawer

  Scenario: Cash Management _ Validation of Till In Transactions - Starting Bank Initialize the Drawer
