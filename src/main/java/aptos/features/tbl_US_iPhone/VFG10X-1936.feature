@VFG10X-1936 @ReturnTransaction @Regression
Feature: VFG10X-1936 Return Transaction _Sale of multiple items with multiple employees assigned and item and transactional discount Existing Customer Assigned
