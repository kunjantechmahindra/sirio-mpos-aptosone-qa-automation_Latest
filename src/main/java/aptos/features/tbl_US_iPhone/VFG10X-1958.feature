@VFG10X-1958 @ExchangeTransaction @Regression @GiftCard
Feature: VFG10X-1958 Exchange _Multiple sale items _Void one item and void payment by gift card and complete by cash
