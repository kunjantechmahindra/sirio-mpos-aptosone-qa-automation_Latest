@VFG10X-1955 @ExchangeTransaction @Regression @Card @VisaMaster
Feature: VFG10X-1955 Exchange _Negative Exchange transaction of mixed card payment with temp MD item without perm price_Refund also should go to both cards

  Scenario: Exchange _Negative Exchange transaction of mixed card payment with temp MD item without perm price_Refund also should go to both cards
