@VFG10X-1966 @ExchangeTransaction @Regression

Feature: VFG10X-1966 Exchange_ Return with receipt of multiple items with employee discount _Single item sale
