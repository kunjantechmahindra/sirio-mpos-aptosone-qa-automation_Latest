@VFG10X-1897 @SaleTransaction @Regression @GiftCard
Feature: VFG10X-1897 Sale Transaction _Single Item with Line item Discount _Payment by multiple Gift Cards
  ...
  # Payment transaction
    ...
    And the sales assistant enter the gift card number for payment from index 6
