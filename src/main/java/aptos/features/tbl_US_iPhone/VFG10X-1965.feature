@VFG10X-1965 @ExchangeTransaction @Regression @GiftCard @Card
Feature: VFG10X-1965 Exchange _Multiple items with same price _Top Up gift card_ Loyalty Customer Assigned
