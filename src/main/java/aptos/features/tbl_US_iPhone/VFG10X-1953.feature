@VFG10X-1953 @ReturnTransaction @Regression @Card @Diners
Feature: VFG10X-1953 Return Transaction _Sale of Single item with Promo _Refund to Diners card _Existing Customer
