@VFG10X-1916 @SaleTransaction @Regression
Feature: VFG10X-1916 Sale Transaction _Multiple Items with Bag Fee_ Payment by Cash_ No customer
  ...
  # Add Bag and complete Payment transaction
