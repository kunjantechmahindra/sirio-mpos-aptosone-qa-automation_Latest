@VFG10X-1809 @Regression @ExchangeTransaction @Card @Visa

Feature: VFG10X-1809 Exchange _Blind Exchange _Single item with Tax override _Refund as card_No Customer
