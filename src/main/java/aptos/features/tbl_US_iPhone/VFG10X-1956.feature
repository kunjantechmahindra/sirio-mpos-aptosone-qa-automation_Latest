@VFG10X-1956 @ExchangeTransaction @Regression

Feature: VFG10X-1956 Exchange _Single Item with Item level discount on the return transaction_ Existing Customer
