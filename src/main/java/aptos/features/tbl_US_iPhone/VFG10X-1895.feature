@VFG10X-1895 @SaleTransaction @Regression @GiftCard @Card
Feature: VFG10X-1895 Sale Transaction _Multiple Items with multiple line item discounts _Payment by New Gift Card_ Existing customer
