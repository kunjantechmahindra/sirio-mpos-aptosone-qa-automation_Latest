@VFG10X-1893 @SaleTransaction @Regression @Card @Master
Feature: VFG10X-1893 Sale Transaction _Single Item with Bag Fee_ Void Payment by Credit Card and complete by Cash_ Existing customer
