@VFG10X-1952 @ReturnTransaction @Regression @GiftCard
Feature: VFG10X-1952 Return Transaction _Single item with tax override with payment by Gift Card _Refund to Gift card _No Customers
  ...
  # Apply Tax override
    ...
    And the sales assistant enter transactional level tax rate as 7
  ...
  # Payment transaction
    ...
    And the sales assistant enter the the pin from index 5
