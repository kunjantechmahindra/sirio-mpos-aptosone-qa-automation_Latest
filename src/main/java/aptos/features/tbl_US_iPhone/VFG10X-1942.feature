@VFG10X-1942 @ReturnTransaction @Regression
Feature: VFG10X-1942 Return Transaction _Return item with Physical receipt _Refund by Cash _New customer assigned
