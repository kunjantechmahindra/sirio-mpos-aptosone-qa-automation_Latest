@VFG10X-1968 @Regression @GiftCard
Feature: VFG10X-1968 Gift Card _ Issue of New Gift Card by swiping the gift card_ Payment by Credit card
  ...
  #Issue New Gift Card
    ...
    And the sales assistant enters gift card amount "200.00"
