@VFG10X-1896 @SaleTransaction @Regression @Card @GiftCard @Visa
Feature: VFG10X-1896 Sale Transaction _Normal item and Gift card item_ Partial Payment by Cash & Visa Card_ No customer
