@VFG10X-1938 @TaxManagement @Regression

Feature: VFG10X-1938 Tax _ Sales Transaction with Multiple Items _One item with Tax exempt and One without Tax exempt
