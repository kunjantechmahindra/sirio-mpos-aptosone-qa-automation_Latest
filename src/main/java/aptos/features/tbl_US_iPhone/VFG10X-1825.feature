@VFG10X-1825 @Customer @Regression
Feature: VFG10X-1825 Customer search using phone number
  ...
  #Search Customer using Phone
    ...
    And the sales assistant search a customer with Phone Number at index 1
