@VFG10X-272 @PriceOverride @Regression

Feature: VFG10X-272 Price Override _Sale Transaction with Price override for Multiple items_ Reason code PRICE MATCH & INCORRECT PRICE
