@VFG10X-1707 @ExchangeTransaction @Regression @DetailedCalculation
Feature: VFG10X-1707 Exchange _Positive Blind Exchange transaction with multiple items with Promo on exchange transaction_Payment by Cash with change
