@VFG10X-1708  @Regression @DetailedCalculation
Feature: VFG10X-1708 Exchange _Single item with Price Override on the exchange transaction
 ...
 #Return transaction
    ...
    #intermittenly we are getting a customer page ,use skip step
    #And the sales assistant clicks on Skip button
    And the sales assistant validate the price of the product is 40 at index 2
