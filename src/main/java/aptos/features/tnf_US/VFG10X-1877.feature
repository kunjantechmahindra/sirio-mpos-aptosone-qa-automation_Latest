@VFG10X-1877 @ReturnTransaction @Regression @DetailedCalculation

Feature: VFG10X-1877 Return Transaction _ Receipt Return with Temp MD item having Price Override and Promo applied

  Scenario: Return Transaction _ Receipt Return with Temp MD item having Price Override and Promo applied
