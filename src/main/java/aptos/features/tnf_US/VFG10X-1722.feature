@VFG10X-1722 @ReturnTransaction @Regression

  Feature: VFG10X-1722 Return transaction_Return item with Temp Price + Tax exempt + BOGOF + Emp Disc and Search customer using email to retrieve sale transaction

    Scenario: Return transaction_Return item with Temp Price + Tax exempt + BOGOF + Emp Disc and Search customer using email to retrieve sale transaction
