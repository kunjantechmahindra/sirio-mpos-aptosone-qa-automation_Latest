...
Feature: VFG10X-1550  Promotions and Discounts _Transactional level discount reason code -Nurse in TNF and REGIONAL MKTG  in TBL

  Scenario: Promotions and Discounts _Transactional level discount reason code -Nurse in TNF and REGIONAL MKTG  in TBL
  ...
  # EJ Validation
    ...
    And the sales assistant validate the the reason code ID 152
    And the sales assistant validate details "Nurse" in EJ
