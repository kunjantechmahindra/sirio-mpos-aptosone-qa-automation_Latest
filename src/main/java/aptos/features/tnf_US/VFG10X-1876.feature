@VFG10X-1876 @Regression @DetailedCalculation @Card @Visa
Feature: VFG10X-1876 Sale Transaction _Multiple Items with Tax Exempt and Coupon applied_ Bag Fee_ Void Payment by Credit Card and complete by Cash_ New customer
