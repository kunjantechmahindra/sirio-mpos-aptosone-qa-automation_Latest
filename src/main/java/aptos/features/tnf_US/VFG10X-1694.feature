@VFG10X-1694 @SaleTransaction @Regression @DetailedCalculation @GiftCard
Feature: VFG10X-1694 Sale Transaction _Single Item with Tax Override and Coupon Applied_ Payment by Gift card & Cash
