@VFG10X-1671 @Regression @GiftCard
...
Feature: VFG10X-1671 Gift Card _Unable to apply Item Level & Transactional Level discount and Price Override a New Gift card Item in a transaction
  ...
  #Gift card balance enquiry
    Then the sales assistant validates the Gift Card balance from basket page for index 5
    Then the sales assistant enter the the pin from index 5
