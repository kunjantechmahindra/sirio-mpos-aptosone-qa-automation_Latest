@VFG10X-1697 @ReturnTransaction @Regression @Card @DetailedCalculation @VisaAndDebit
Feature: VFG10X-1697 Return Transaction _Refund to different Payment methods _ 1st item 24% OFF and 2nd Item 30$ amount off with receipt with Reason Code:RTL - WRONG SIZE/COLOR
