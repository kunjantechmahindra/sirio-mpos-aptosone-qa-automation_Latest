@VFG10X-1699 @ReturnTransaction @Regression @DetailedCalculation @Card @Visa

Feature: VFG10X-1699 Return Transaction _ Blind Return with multiple items and add tax exempt to the return transaction_Refund to Cash_Existing customer assigned
