@VFG10X-805 @CashManagement @Regression
Feature: VFG10X-805 Cash Management _PAID IN_ Reason Code as Non-Sufficient Funds for TBL and Inventory Meal for TNF

  Scenario: Cash Management _PAID IN_ Reason Code as Non-Sufficient Funds for TBL and Inventory Meal for TNF
