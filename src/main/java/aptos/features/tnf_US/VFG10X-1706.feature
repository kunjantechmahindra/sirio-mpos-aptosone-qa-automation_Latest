@VFG10X-1706 @ExchangeTransaction @Regression @DetailedCalculation
Feature: VFG10X-1706 Exchange _Negative Exchange by hand typing the transaction barcode with Single item with Coupon on exchange transaction_Refund to Cash
