@VFG10X-809 @CashManagement @Regression
Feature: VFG10X-809 Cash Management _PAID IN_ Reason code - Customer Accommodations for TBL and Money Found in Drawer for TNF.

  Scenario: Cash Management _PAID IN_ Reason code - Customer Accommodations for TBL and Money Found in Drawer for TNF.
  ...
  #PAID IN Store Operations
    ...
    And the sales assistant selects "Money Found in Drawer" as reason code
