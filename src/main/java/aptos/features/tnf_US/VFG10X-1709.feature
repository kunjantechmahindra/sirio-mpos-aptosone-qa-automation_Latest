@VFG10X-1709 @Regression @DetailedCalculation

Feature: VFG10X-1709 Exchange Transaction_Blind Exchange transaction with Single and Same item with Tax Override on the return item_Payment by Cash_Existing loyalty Customer Assigned
