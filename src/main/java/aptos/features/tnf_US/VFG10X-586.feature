@VFG10X-586 @StoreSelling @Regression @GiftCard
Feature: VFG10X-586 Store Selling Functions _ Maximum Gift Card Issue Amount
  ...
  #Issue New Gift Card
    ...
    And the sales assistant enters valid gift card amount "1000.00"
