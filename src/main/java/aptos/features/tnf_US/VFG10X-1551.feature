@VFG10X-1551 @PromotionsAndDiscounts @Regression
Feature: VFG10X-1551  Promotions and Discounts _Transactional level discount reason code -Other in TNF

  Scenario: Promotions and Discounts _Transactional level discount reason code -Other in TNF
  ...
  # EJ Validation
    ...
    And the sales assistant validate the the reason code ID 136
