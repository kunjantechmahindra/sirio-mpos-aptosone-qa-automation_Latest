@VFG10X-254 @ReturnTransaction @Regression @Card @Discover @SmokeTNF
Feature: VFG10X-254 Return Transaction _ Receipt less Return with Different reason codes _CHANGED MIND and PRICE ADJUSTMENT
...
#Refund transaction
 ...
 #EJ Validation
    ...
    And the sales assistant validate details "Price Adjustment" in EJ
