@VFG10X-813 @CashManagement @Regression
Feature: VFG10X-813 Cash Management _PAID OUT _ Reason code as Team Meals for TBL and Inventory Meal for TNF

  Scenario: Cash Management _PAID OUT _ Reason code as Team Meals for TBL and Inventory Meal for TNF
