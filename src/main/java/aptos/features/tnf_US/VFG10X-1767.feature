@VFG10X-1767 @DetailedCalculation @Regression
Feature: VFG10X-1767 Sales transaction with XPLR pass
  ...
  #validate XPLR pass promotion
    ...
    And the sales assistant validate the discount applied as "XPLR 10% off"
