@VFG10X-103 @StoreSelling @Regression

Feature: VFG10X-103 Store Selling Functions_ Transactional Level Tax Override Option
  ...
  #Validates Tax override button in transactional level is unavailable
