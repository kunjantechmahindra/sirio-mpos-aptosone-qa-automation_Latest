@VFG10X-1670 @PromotionsAndDiscounts @Regression @GiftCard

Feature: VFG10X-1670 Promotions and Discounts _ Verify that promotion is not getting applied to Top Up Gift Card
