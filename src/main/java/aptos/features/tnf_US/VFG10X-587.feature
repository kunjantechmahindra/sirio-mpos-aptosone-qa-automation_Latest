@VFG10X-587 @StoreSelling @Regression @GiftCard
Feature: VFG10X-587 Store Selling Functions _ Minimum Gift Card Top UP Amount

  Scenario: Store Selling Functions _ Minimum Gift Card Top UP Amount
  ...
  #Issue New Gift Card
    ...
    And the sales assistant enters valid gift card amount "0.01"
