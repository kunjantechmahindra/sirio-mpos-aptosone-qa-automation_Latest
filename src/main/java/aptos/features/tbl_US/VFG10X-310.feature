@VFG10X-310 @Customer @Regression @SmokeTBL
Feature: VFG10X-310 Customer _Search using Email Id and phone number
  ...
  #Search Customer using Email and Phone Number
    ...
    And the sales assistant search a customer with Phone Number and email at index 5
    And the sales assistant validate the customer details at index 5
