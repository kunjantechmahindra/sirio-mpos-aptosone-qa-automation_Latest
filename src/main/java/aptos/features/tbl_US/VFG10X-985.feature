@VFG10X-985 @StoreSelling @Regression @Card @Amex

Feature: VFG10X-985 Store Selling Functions _Signature prompt for all return transactions_ without the original sales receipts.

  Scenario: Store Selling Functions _Signature prompt for all return transactions_ without the original sales receipts.
