@VFG10X-837 @CashManagement @Regression
Feature: VFG10X-837 Cash Management _PAID OUT _ Reason Code - Customer Accommodations

  Scenario: Cash Management _PAID OUT _ Reason Code - Customer Accommodations
