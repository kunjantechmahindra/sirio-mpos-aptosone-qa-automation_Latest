@VFG10X-1756 @Regression @GiftCard @Card @DetailedCalculation
Feature: VFG10X-1756 Exchange _Negative Blind Exchange of single item with bag fee on exchange transaction_Issue New Gift card for refund_No Customer Assigned
