@VFG10X-1753 @PromotionsAndDiscounts @Regression @DetailedCalculation
Feature: VFG10X-1753 Promotions and Discounts _ Sale transaction with Coupon - 20% with Coupon
