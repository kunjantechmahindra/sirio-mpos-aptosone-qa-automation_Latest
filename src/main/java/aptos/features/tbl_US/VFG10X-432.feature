@VFG10X-432 @PromotionsAndDiscounts @Regression
Feature: VFG10X-432 Promotions and Discounts _ Block Item level Discount _Discount percentage above 70 for TBL

  Scenario: Promotions and Discounts _ Block Item level Discount _Discount percentage above 70 for TBL
  ...
  #Login and add item to basket add items
    ...
    And the sales assistant validates an error message while entering discount percentage above 70
