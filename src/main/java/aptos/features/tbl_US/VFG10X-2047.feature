@VFG10X-2047 @ReturnTransaction @Regression
Feature: VFG10X-2047 Return Transaction _ Refund _Sale transaction paid using Reward_Reward points deducted on refund
