@VFG10X-2321 @ExchangeTransaction @Regression @DetailedCalculation
Feature: VFG10X-2321 Exchange Transaction_Exchange multi-items, Sale 1st item with Price-Override and Return 2nd item with 15 %Tax-Override with Receipt
