@VFG10X-906 @CashManagement @Regression
Feature: VFG10X-906 Cash Management _PAID OUT _ TBL Reason Code validation_Alphabetic order

  Scenario: Cash Management _PAID OUT _ TBL Reason Code validation_Alphabetic order
  ...
  #PAID OUT Store Operations
    ...
    And the sales assistant selects "MAINTENANCE" as reason code
