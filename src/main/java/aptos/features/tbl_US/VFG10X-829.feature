@VFG10X-829 @CashManagement @Regression
Feature: VFG10X-829 Cash Management _PAID OUT_ Reason Code - Maintenance

  Scenario: Cash Management _PAID OUT_ Reason Code - Maintenance
