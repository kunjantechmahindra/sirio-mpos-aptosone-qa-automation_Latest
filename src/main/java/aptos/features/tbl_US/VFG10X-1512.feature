@VFG10X-1512 @GiftCard @Regression @Card
Feature: VFG10X-1512 Gift Card _ Issue of New Gift Card by typing the incorrect gift card number_ Validate the error message
