@VFG10X-1891 @Customer @Regression @Loyalty
Feature: VFG10X-1891 Verify loyalty Customer once loyalty opted-in cannot be opted-out

  Scenario: Verify loyalty Customer once loyalty opted-in cannot be opted-out
