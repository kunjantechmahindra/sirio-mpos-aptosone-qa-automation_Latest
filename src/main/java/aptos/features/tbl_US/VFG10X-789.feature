@VFG10X-789 @CashManagement @Regression
Feature: VFG10X-789 Cash Management _PAID IN_ Reason Code - Maintenance

  Scenario: Cash Management _PAID IN_ Reason Code - Maintenance
