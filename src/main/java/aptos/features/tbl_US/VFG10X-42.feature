...
Feature: VFG10X-42 Store Selling Functions _Terminated Employee to be assigned as a salesperson to a transaction
  ...
  # Assign sale person
    ...
    And the sales assistant add terminated salesperson "900500" to the transaction
