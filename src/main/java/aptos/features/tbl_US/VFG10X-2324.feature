@VFG10X-2324 @PromotionsAndDiscounts @Regression @DetailedCalculation @Smoke
Feature: VFG10X-2324 Promotions and Discounts _ Sale transaction with stacked promotions _Exclusivity set to "Do not Combine"
