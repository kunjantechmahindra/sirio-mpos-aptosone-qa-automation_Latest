@VFG10X-918 @CashManagement @Regression
Feature: VFG10X-918 Cash Management _PAID OUT _ TNF Reason Code validation_Alphabetic order

  Scenario: Cash Management _ PAID OUT _ TNF Reason Code validation_Alphabetic order
