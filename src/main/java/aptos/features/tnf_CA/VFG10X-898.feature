...
Feature: VFG10X-898 Price Override _Suspend and Resume_Sales transaction with price override with Reason Code: CUSTOMER ADJUSTMENT for TNF

  Scenario: Price Override _Suspend and Resume_Sales transaction with price override with Reason Code: CUSTOMER ADJUSTMENT for TNF
