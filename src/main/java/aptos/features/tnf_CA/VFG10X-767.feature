@VFG10X-767 @SaleTransaction @Regression @Card @GiftCard
Feature: VFG10X-767 Gift Card _ Gift Card tender Exchange by swiping the Gift Card + PIN

  Scenario: Gift Card _ Gift Card tender Exchange by swiping the Gift Card + PIN
