@VFG10X-817 @CashManagement @Regression
Feature: VFG10X-817 Cash Management _PAID OUT _ Reason code as Postage for TBL and Fill the Fridge for TNF

  Scenario: Cash Management _PAID OUT _ Reason code as Postage for TBL and Fill the Fridge for TNF
