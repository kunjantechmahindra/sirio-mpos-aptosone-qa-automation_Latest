@VFG10X-801 @CashManagement @Regression
Feature: VFG10X-801 Cash Management _PAID IN_ Reason Code - Contests for TBL and Holiday Meal for TNF

  Scenario: Cash Management _PAID IN_ Reason Code - Contests for TBL and Holiday Meal for TNF
