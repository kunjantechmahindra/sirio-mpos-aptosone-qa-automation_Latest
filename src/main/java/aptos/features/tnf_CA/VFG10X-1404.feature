@VFG10X-1404 @SaleTransaction @Regression

Feature: VFG10X-1404 Validate transaction receipt footer - Outlet - Last day of Refund and Thank you msg

  Scenario: Validate transaction receipt footer - Outlet - Last day of Refund and Thank you msg
