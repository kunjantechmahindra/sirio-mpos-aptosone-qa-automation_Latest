@VFG10X-1402 @Regression @StoreSelling
Feature: VFG10X-1402 Store Selling Functions _Validation of the possibility to modify the reason code for a returned item, once selected
 ...
 #Return transaction
  ...
  #Change Reason Code
    ...
    And the sales assistant selects the product at index 1
    And the sales assistant validate "RTL - Damaged/Defective" is applied to item
