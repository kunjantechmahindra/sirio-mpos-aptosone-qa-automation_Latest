@VFG10X-592 @StoreSelling @Regression
Feature: VFG10X-592 Store Selling Functions _ Not able to issue gift card for zero dollars

  Scenario: Store Selling Functions _ Not able to issue gift card for zero dollars
