@VFG10X-1045 @ReturnTransaction @Regression
Feature: VFG10X-1045 Return transaction_Return multiple items with Transaction Employee Discount Get E-Receipt

  Scenario: Return transaction_Return multiple items with Transaction Employee Discount Get E-Receipt
