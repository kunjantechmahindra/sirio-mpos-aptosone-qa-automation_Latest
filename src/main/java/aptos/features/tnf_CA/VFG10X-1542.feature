@VFG10X-1542 @PromotionsAndDiscounts @Regression
Feature: VFG10X-1542 Promotions and Discounts _Transactional level discount reason code - Post Card Promo in TNF

  Scenario: Promotions and Discounts _Transactional level discount reason code - Post Card Promo in TNF
  ...
  #Login and add product
    ...
    And the sales assistant validate the the reason code ID 130
