@VFG10X-1543 @PromotionsAndDiscounts @Regression
Feature: VFG10X-1543 Promotions and Discounts _Transactional level discount reason code - as Price Match in TNF and Email in TBL

  Scenario: Promotions and Discounts _Transactional level discount reason code - as Price Match in TNF and Email in TBL
  ...
  # EJ Validation
    ...
    And the sales assistant validate the the reason code ID 131
